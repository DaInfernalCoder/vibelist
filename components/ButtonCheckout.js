...
const ButtonCheckout = ({ priceId, mode = "payment" }) => {
  ...
  return (
    <div className="w-full">
      <button
        className="btn btn-block bg-[#9334E9] hover:bg-[#7C2D9E] text-white border-0 group disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      >
        ...
        {isLoading ? "Processing..." : `Get ${config?.appName}`}
      </button>
